    ...
    <>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto text-base md:text-lg">
            Discover our handpicked selection of premium quality items that are
            trending right now.
          </p>
      ...
      <section className="py-16 lg:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-center text-gray-600 mb-12 max-w-3xl mx-auto text-base md:text-lg">
            Whatever your style, we've got the perfect pieces to complete your
            space.
          </p>
