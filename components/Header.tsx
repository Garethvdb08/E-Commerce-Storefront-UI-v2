...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className="absolute top-0 left-0 h-1 bg-gradient-to-r from-cyan-400 to-blue-600 z-10"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-5">
            <a
              href="/coming-soon"
              className="hidden sm:block text-gray-600 hover:text-blue-600 transition-colors duration-300"
            >
              <Icon name="search" />
            </a>
            <a
            ...
            <nav className="flex flex-col space-y-2 p-4">
              {navLinks.map((link) => (
                <a
                  key={link}
                  href="/coming-soon"
                  className="text-gray-600 hover:text-blue-600 transition duration-300 p-2 rounded hover:bg-gray-100"
                >
                  {link}
                </a>
              ))}
